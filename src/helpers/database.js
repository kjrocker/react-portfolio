const database = {
  ...
  "companies" : [ {
    "business" : "Web and Software Consultancy",
    "id" : "levvel",
    "name" : "Levvel"
  }, {
    "business" : "Clinical Laboratory",
    "id" : "pcls",
    "name" : "Physician's Choice Laboratory Services"
  }, {
    "business" : "University",
    "id" : "unc",
  ...
  "jobs" : [ {
    "company" : "levvel",
    "end" : "April 2017",
    "items" : [ "Extended a pre-existing Ruby on Rails codebase with new features, and tied those into existing processes", "Worked within a large C# and Angular web application to apply many surgical fixes and additions to existing code" ],
    "logoUrl" : "",
    "start" : "September 2016",
    "summary" : "Worked with clients to create effective, maintainable software solutions addressing a wide array of needs.",
    "title" : "Consultant"
  }, {
    "company" : "pcls",
    "end" : "July 2016",
    ...
    "logoUrl" : "",
    "start" : "June 2012",
    "summary" : "Responsible for a broad array of services within the QC department, including instrument maintenance and data analysis. Developed automation tools using Excel and VBA to increase department productivity.",
    "title" : "QC Metrologist"
  }, {
    "company" : "unc",
    "end" : "May 2014",
    "items" : [ "Performed computational research on the lab's SNP microarray data", "Implemented part of the statistical analysis required to turn this microarray into a toolkey for determining the subspecies of mixed wild mouse populations", "Used combinations of SQL, R, and Python to mine the microarray data for any statistically significant trends of research interest" ],
    "logoUrl" : "",
    "start" : "Spring 2013",
    "summary" : "Managed my own research project, involving analysis of genotype data to meet broader research objectives.",
